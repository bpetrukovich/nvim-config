return {
  ...
  config = function()
    local conf = {
      ...
      default_command_agent = 'openrouterAgent',
      default_chat_agent = 'openrouterAgent',

      -- default_command_agent = 'nvidiaAgent',
      -- default_chat_agent = 'nvidiaAgent',
      ...
      agents = {
        {
          ...
          model = { model = 'deepseek/deepseek-chat-v3-0324:free', temperature = 0.8, top_p = 0.9 },
          -- system prompt (use this to specify the persona/role of the AI)
          -- system_prompt = require('gp.defaults').code_system_prompt,
          system_prompt = 'Imagine that you are a professional and experienced lead developer ready to analyze code and requirements at the highest level.',
        },
        {
          provider = 'nvidia',
          name = 'nvidiaAgent',
          ...
          command = true,
          -- string with model name or table with model name and parameters
          model = { model = 'meta/llama-3.3-70b-instruct', temperature = 0.8, top_p = 0.9 },
          -- system prompt (use this to specify the persona/role of the AI)
          -- system_prompt = require('gp.defaults').code_system_prompt,
    ...
    vim.keymap.set({ 'n', 'i' }, '<C-g><C-t>', '<cmd>GpChatNew <cr>', keymapOptions 'New Chat tabnew')

    vim.keymap.set('v', '<C-g><C-v>', ":<C-u>'<,'>GpChatNew vsplit<cr>", keymapOptions 'Visual Chat New vsplit')
    vim.keymap.set('v', '<C-g><C-t>', ":<C-u>'<,'>GpChatNew <cr>", keymapOptions 'Visual Chat New tabnew')
    ...
    vim.keymap.set({ 'n', 'i' }, '<C-g>gt', '<cmd>Gp<cr>', keymapOptions 'GpTabnew')

    vim.keymap.set('v', '<C-g>gp', ":<C-u>'<,'>GpPopup<cr>", keymapOptions 'Visual Popup')
    vim.keymap.set('v', '<C-g>ge', ":<C-u>'<,'>GpEnew<cr>", keymapOptions 'Visual GpEnew')
    vim.keymap.set('v', '<C-g>gn', ":<C-u>'<,'>GpNew<cr>", keymapOptions 'Visual GpNew')
    vim.keymap.set('v', '<C-g>gv', ":<C-u>'<,'>GpVnew<cr>", keymapOptions 'Visual GpVnew')
    vim.keymap.set('v', '<C-g>gt', ":<C-u>'<,'>Gp<cr>", keymapOptions 'Visual GpTabnew')
