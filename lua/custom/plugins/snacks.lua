return {
  ...
  keys = {
    ...
    { '<leader>si', function() Snacks.picker.files { hidden = true, ignored = true } end, desc = '[S]earch [I]gnored files' },
    ...
    -- Buffers & Recent
    { '<leader>bb', function() Snacks.picker.buffers() end, desc = 'Find existing [B]uffers' },
    ...
    -- Git
    { '<leader>sb', function() Snacks.picker.git_branches() end, desc = '[S]earch [B]ranches' },

    -- LSP (these will work when buffer has LSP attached)
    { '<leader>sl', function() Snacks.picker.lsp_symbols() end, desc = '[S]ymbols [L]ist (document)' },
