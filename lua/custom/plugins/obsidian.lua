return {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set('n', '<leader>on', '<cmd>ObsidianNewFromTemplate<CR>', { desc = 'Create New Note' })
    vim.keymap.set('n', '<leader>os', '<cmd>ObsidianSearch<CR>', { desc = 'Search Obsidian' })
    vim.keymap.set('n', '<leader>oq', '<cmd>ObsidianQuickSwitch<CR>', { desc = 'Quick Switch' })
    vim.keymap.set('n', '<leader>op', '<cmd>ObsidianPasteImg<CR>', { desc = 'Paste Image' })
    vim.keymap.set('n', '<leader>od', '<cmd>ObsidianDailies<CR>', { desc = 'Show Obsidian Dailies' })
    vim.keymap.set('n', '<leader>ot', '<cmd>ObsidianTemplate<CR>', { desc = 'Show Obsidian Dailies' })
    vim.keymap.set('n', '<leader>om', '<cmd>ObsidianTags<CR>', { desc = 'Obsidian Tags' })
  end,
}
